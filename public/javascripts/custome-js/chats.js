...
//             </div>
//             <input type="text" id="inputMessage" placeholder="Type message..." class="shadow p-3 rounded position-absolute bottom-0 mb-2 w-75" style=" border:none;height:30px;border-radius:10px">
...
$(document).off('click', '.clickToChat').on('click', '.clickToChat', function () {
    ...
    $.ajax({
        ...
        success: function (chatUserDetails) {
            ...
            <div class="mb-3 row">
            <div class="col-sm-11">
                 <input type="text" class="form-control text-red" id="inputMessage" placeholder="Type message..."  class="w-100  p-3  position-absolute bottom-0 mb-2 w-75" style=" border:none;border-radius:10px; box-shadow:10px 5px 5px grey">
